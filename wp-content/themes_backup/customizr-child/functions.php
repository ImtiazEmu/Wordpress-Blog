...
function load_my_styles() {
    wp_enqueue_style( 'customizr', get_template_directory_uri() . '/inc/assets/css/bootstrap.css' );

    //wp_enqueue_script( 'custom', get_template_directory_uri() . '/inc/assets/js/custom.js' );

    wp_register_script('custom-script', get_template_directory_uri() . '/inc/assets/js/bootstrap.js', array('jquery'));
