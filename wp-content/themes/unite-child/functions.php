...
function unite_scripts() {
  ...
  wp_enqueue_style( 'unite-custom', get_template_directory_uri() . '/inc/css/custom.css', array('unite-bootstrap') );
  ...
  wp_enqueue_style( 'unite-icons', get_template_directory_uri().'/inc/css/font-awesome.min.css' );
	...
	wp_enqueue_script('unite-custom', get_template_directory_uri().'/inc/js/custom.js' );
